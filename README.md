## Olá! Eu sou Dariel Acosta atualmente graduando da UFSC
<div>
...
### Ferramentas e linguagens em aprendizado:
<div style="display: inline_block">
...
- Comecei em fevereiro de 2022 um estágio na universidade onde estudo no Núcleo de Desenvolvimento de Sistema. Nesse estágio aprendi sobre JavaScript, CSS, HTML, NodeJs, ReactJs e Git para a criação e manutenção de sistemas ligados à universidade.
- Flutter e Dart comecei os estudos por conta própria em janeiro de 2020 e cheguei a criar um aplicativo para android chamado Evo Invest o qual está atualmente (18 de dezembro de 2022) na Play Store (https://play.google.com/store/apps/details?id=com.acostacampos.evo_invest).
- MongoDb, MySql e PostgreSql aprendi durante a faculdade em disciplinas como Banco de Dados (Somente bancos relacionais) e na disciplina de Programação Web aprendi sobre o MongoDb.
##
